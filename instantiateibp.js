...
*/
/*
 * Chaincode Instantiate chaincode
 */
...
var order = fabric_client.newOrderer('grpcs://n55536e1b2a2d4491b41bbed32a580e52-orderer.us01.blockchain.ibm.com:31001', { 'pem' : Buffer.from(tlscacert).toString()});
...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	// send the instantiate chaincode proposal to the peers
	...
	if (proposalResponses && proposalResponses[0].response &&
		proposalResponses[0].response.status === 200) {
			isProposalGood = true;
			console.log('Instantiate chaincode proposal was good');
		} else {
			console.error('Instantiate chaincode proposal was bad');
		}
	if (isProposalGood) {
	...
	console.error('Failed to instantiate chaincode successfully :: ' + err);
});
